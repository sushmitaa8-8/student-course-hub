...
-- 4. The database will be created from scratch
--
...
-- UNIQUE KEY on Email + ProgrammeID prevents duplicate registrations
CREATE TABLE InterestedStudents (
    ...
    UNIQUE KEY unique_interest (Email, ProgrammeID),
